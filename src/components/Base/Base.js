...
import PrimarySearchBar from '../sub-components/inputs/PrimarySearchBar';
import ServiceItemPlaceholder from './sub-components/ServiceItemPlaceholder';
import ServiceList from './sub-components/ServiceList';
